...
we call it \textbf{inertia tensor}\index{inertia!tensor} referred to the center of mass of the i-th link \underline{expressed in the base frame}.
...
\subsection{Skew-symmetry of matrix \texorpdfstring{$\dot{\matr{B}} - 2\matr{C}$}{dB-2C}}
